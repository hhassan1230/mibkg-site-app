            ...
            <section>
                    <div className="desktop screen">
                        ...
                        <div className="tabs-final menu" id="menu">
                            ...
                            <a href="#about-bal" target="_blank">
                            ...
                            <a href="https://www.linkedin.com/company/made-in-brooklyn-games/" target="_blank">
                                ...
                                <img className="shape-7mxTZx smart-layers-pointers"  alt="" src="assets/img/mobile-menu-overlay-shape-EAB77E60-DA83-4AFB-B070-A59CC88BDFC0@2x.png"/></div></a>
                            <a href="#">
                                <div className="twitter animate-enter4" show-on-scroll="">
                                <img className="shape-7mxtwx smart-layers-pointers" alt="" src="assets/img/mobile-menu-overlay-path-4738644C-66F0-49A4-BD66-1DCA299233A3@2x.png"/></div>
                            </a>
                            <a href="https://www.facebook.com/MiBKG" target="_blank">
                                <div className="facebook animate-enter6" show-on-scroll="">
                                <img className="path-kT5t8C smart-layers-pointers" alt="" src="assets/img/mobile-menu-overlay-path-CA2DB456-2CEB-45BF-8D6E-2F41D27B334A@2x.png"/></div></a>
                            <a href="https://www.instagram.com/madeinbkgames/" target="_blank">
                                ...
                                <img className="shape-vRRNIw" alt="" src="assets/img/mobile-menu-overlay-shape-988B7600-1D1B-4E4B-98B7-6882237994EB@2x.png"/>
                                <img className="path-vRRNIw" alt="" src="assets/img/mobile-menu-overlay-path-5DE0C9A7-C246-4F6D-9890-24C641C4FCA0@2x.png"/>
                                </div>
                            </a>
                            </div>
                        </div>
